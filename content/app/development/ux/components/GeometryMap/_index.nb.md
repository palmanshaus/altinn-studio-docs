---
title: GeometryMap
linktitle: GeometryMap
description: # Kort beskrivelse av komponenten
schemaname: GeometryMap # Komponentens schema-navn, brukes for å automatisk generere liste med egenskaper fra komponentens JSON schema (erstatt med riktig navn i henhold til schema)
...
GeometryMap er ment til å brukes i de situasjoner hvor man ønsker ha en oversikt over gitte geometriske områder, og ikke kun punkt slik som i Map. 

### Anatomy

![GeometryMap](GeometryMap.png)

{{% anatomy-list %}}
1. **Zoom ut**: Se et større område med færre detaljer.
2. **Zoom inn**: Se flere detaljer i et mindre område.
3. **Polygon**: Geometrien som tegnes opp fra gitte koordinater. Viser tilhørende tekst ved hover over.
{{% /anatomy-list %}}
...
* For kart med punkt-markør istedenfor geometrier: [Map](../Map/).
      ...
      "layout": [
        {
          ...
          "type": "GeometryMap",
          "dataModelBindings": {
            "array": "Some.Deep.Object.ContainingAnArray",
            "wkt": "Some.Deep.Object.ContainingAnArray.wktString",
            "label": "Some.Deep.Object.ContainingAnArray.someText"
          }
        }
      ]
    }
